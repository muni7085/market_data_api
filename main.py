from data_provider.smart_api.websocket_call_backs import DataWebSocket
from data_provider.smart_api.get_connection import SmartApiConnection
from data_provider.smart_api.utils.constants import API_KEY,CLIENT_ID
...
data_websocket=DataWebSocket(auth_token,API_KEY,CLIENT_ID,feed_token,tokens,correlation_id,mode)
