...
The module defines the DataProvider enum, which represents the available connection credentials.
It also provides a function to retrieve the credentials for a given credentials name.
