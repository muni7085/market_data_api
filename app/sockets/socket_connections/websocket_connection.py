...
class WebsocketConnection(ABC, Registrable):
    ...
    exchange and instrument type. The subclasses should also has a class method `from_cfg` to
    create the object from the configuration to abstract complex object creation logic
